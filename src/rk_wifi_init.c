...
#define RTL8822ES_DRIVER_MODULE_PATH "/system/lib/modules/8822es.ko"
...
#define RTL8822ES_DRIVER_MODULE_NAME "8822es"
...
wifi_ko_file_name module_list[] =
{
    ...
    {"RTL8822ES", RTL8822ES_DRIVER_MODULE_PATH, UNKKOWN_DRIVER_MODULE_ARG, ""},
